# Завдання до теми: Система координат 🐢📍  
...
---
## 🔟 Квадрат з діагоналями по точках із довжиною сторони `a`

Створи програму, у якій черепашка намалює квадрат,  
у якого **довжина сторони** дорівнює `a` пікселів.  

Також потрібно провести **обидві діагоналі квадрата**.

Початкова точка — **правий верхній кут** квадрата з координатами `(x, y)`.
...
## 1️⃣1️⃣ Ромб (повітряний змій) по точках із діагоналями `a` та `b`  
...
### Як має виглядати результат 
![Результат завдання 9](image_task/task_8-9_11.png)
