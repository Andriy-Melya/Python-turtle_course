...
## 8️⃣ 🕸️ П'ятикутна мережа
Черепашка продовжує досліджувати цікаві фігури та візерунки. Цього разу вона захотіла створити п'ятикутну мережу — красиву фігуру з п’яти точок, з’єднаних лініями по колу.  
У кожній вершині майбутньої фігури буде намальовано велике червоне коло, а між ними — чорні відрізки.  

### Параметри:
- Фон — білий
- Кількість вершин — 5
- Довжина сторони п’ятикутника — 100 пікселів
- Колір ліній — чорний
- Товщина пера — 6
- Колір вузлів — червоний
- Радіус вузла — 25 пікселів

### Як має виглядати результат
![Результат завдання 7](image_task/task_4_8.png)
